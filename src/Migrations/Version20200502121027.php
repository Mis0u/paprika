 ...
 */
final class Version20200502121027 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, leader_first_name VARCHAR(255) NOT NULL, leader_last_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
